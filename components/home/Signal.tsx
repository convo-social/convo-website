          ...
          <div className="sig-card large">
            ...
            <div className="sig-card-widget">
              <div className="sig-clips">
                <div className="sig-clip-tile"><video loop muted playsInline style={{width: "100%", height: "100%", objectFit: "cover"}}><source src="https://github.com/convo-social/humanize-website/releases/download/v1-assets/clip-2.mp4" type="video/mp4" /></video><div className="sig-clip-ts">1:23</div></div>
                <div className="sig-clip-tile"><video loop muted playsInline style={{width: "100%", height: "100%", objectFit: "cover"}}><source src="https://github.com/convo-social/humanize-website/releases/download/v1-assets/clip-3.mp4" type="video/mp4" /></video><div className="sig-clip-ts">0:31</div></div>
                <div className="sig-clip-tile center"><video autoPlay loop muted playsInline style={{width: "100%", height: "100%", objectFit: "cover"}}><source src="https://github.com/convo-social/humanize-website/releases/download/v1-assets/clip-5.mp4" type="video/mp4" /></video><div className="sig-clip-ts">2:08</div></div>
                <div className="sig-clip-tile"><video loop muted playsInline style={{width: "100%", height: "100%", objectFit: "cover"}}><source src="https://github.com/convo-social/humanize-website/releases/download/v1-assets/clip-1.mp4" type="video/mp4" /></video><div className="sig-clip-ts">0:47</div></div>
                <div className="sig-clip-tile"><video loop muted playsInline style={{width: "100%", height: "100%", objectFit: "cover"}}><source src="https://github.com/convo-social/humanize-website/releases/download/v1-assets/clip-4.mp4" type="video/mp4" /></video><div className="sig-clip-ts">1:55</div></div>
              </div>
